...
import { ProposalData, ViewMode } from './types';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col print:bg-white print:h-auto print:min-h-0 print:block print-parent-reset">
      {/* Header */}
      <header className="bg-slate-900 text-white shadow-lg sticky top-0 z-50 no-print">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="text-xs text-slate-400">
            v2.1 (Tax Compliance Edition)
          </div>
        </div>
      </header>

      {/* Main Content */}
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 print:w-full print:max-w-none print:p-0 print:m-0 print-parent-reset">
        
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 h-full print:block print:h-auto print-parent-reset">
          ...
          <div className={`${viewMode === ViewMode.RESULT ? 'col-span-12' : 'col-span-1 lg:col-span-8'} print:w-full print:h-auto print-parent-reset`}>
            {viewMode === ViewMode.FORM ? (
              ...
              <div className="h-[800px] lg:h-[calc(100vh-8rem)] print:h-auto print:block print-parent-reset">
                <OutputDisplay 
                  data={formData} 
